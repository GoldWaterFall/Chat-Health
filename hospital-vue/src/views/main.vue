		...
		<nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
			<div class="site-navbar__header">
				<h1 class="site-navbar__brand">
					<a class="site-navbar__brand-lg">Hospital Management System</a>
					<a class="site-navbar__brand-mini">Hospital</a>
				</h1>
			</div>
			<div class="navbar-container" :class="'navbar-container--' + navbarLayoutType">
				...
				<div class="right-container">
					...
					<el-dropdown>
						...
						<template #dropdown>
							<el-dropdown-menu>
								<el-dropdown-item @click="updatePasswordHandle()">Change Password</el-dropdown-item>
				...
				>
					...
					<el-sub-menu index="组织管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						...
						>
							...
							<span slot="title">Department Management</span>
						</el-menu-item>
						<el-menu-item
							index="医疗科室管理"
						...
						>
							<SvgIcon name="company_fill" class="icon-svg" />
							<span slot="title">Medical Department Management</span>
						</el-menu-item>
						<el-menu-item
							index="医疗诊室管理"
						...
						>
							<SvgIcon name="company_fill" class="icon-svg" />
							<span slot="title">Medical Clinic Management</span>
						</el-menu-item>
						<el-menu-item
							index="角色管理"
					...
					<el-sub-menu index="医护管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						<template #title>
							...
							<span slot="title">Medical and Nursing Management</span>
						</template>
						<el-menu-item
							index="医生管理"
						...
						>
							...
							<span slot="title">Physician Management</span>
						</el-menu-item>
						<el-menu-item
							index="护士管理"
						...
						>
							...
							<span slot="title">Nurse Management</span>
						</el-menu-item>
						<el-menu-item
							index="护工管理"
						...
						>
							...
							<span slot="title">Caregiver Management</span>
						</el-menu-item>
						<el-menu-item
							index="诊费设置"
					...
					<el-sub-menu index="出诊管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						...
						>
							...
							<span slot="title">Outpatient Schedule</span>
						</el-menu-item>
						<el-menu-item
							index="医生出诊表"
							v-if="isAuth(['ROOT', 'SCHEDULE:SELECT'])"
						...
						>
							...
							<span slot="title">Doctor's Clinic Schedule</span>
						</el-menu-item>
						<el-menu-item
							index="视频问诊"
						...
						>
							...
							<span slot="title">Video Consultation</span>
						</el-menu-item>
					</el-sub-menu>
					<el-sub-menu
						index="系统设置"
					...
					>
						<template #title>
							...
							<span slot="title">System Configuration</span>
						</template>
					</el-sub-menu>
				</el-menu>
			</div>
